...
The location link is included in the SOS message sent to the saved emergency contacts, allowing them to identify the user's location.
...
The project is built using Flutter and can be configured for multiple platforms including Android, iOS, Web, Windows, Linux, and macOS.

## 🚨 Emergency Workflow

1. User presses the **Emergency SOS** button.
2. The app retrieves the user's current location.
3. The app automatically calls the **first two saved emergency contacts**.
4. An SOS message is automatically sent to **all saved emergency contacts**.
5. The message contains a **Google Maps link** to the user's current location.
